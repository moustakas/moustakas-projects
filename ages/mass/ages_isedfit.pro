pro ages_isedfit, models=models, isedfit=isedfit, qaplot=qaplot, $
  measure=measure, clobber=clobber, debug=debug
; jm09feb22nyu - measure stellar masses for the AGES galaxies 

    iopath = ages_path(/isedfit)
    paramfile = iopath+'ages_isedfit.par'
