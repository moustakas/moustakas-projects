function ages_ppxf_instvdisp, bc03_instvdisp=bc03_instvdisp
; jm09nov12ucsd - convolve the BC03 model templates by the AGES
; instrumental velocity dispersion (see BUILD_AGES_PPXF_TEMPLATES);
