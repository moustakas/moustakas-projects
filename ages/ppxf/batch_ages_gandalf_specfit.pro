pro batch_ages_gandalf_specfit, firstpass, nprocess, solar=solar
; jm09nov18ucsd - batch wrapper script on AGES_GANDALF_SPECFIT
...
;   for ipass = 5, 5 do begin
    for ipass = 0, npass-1 do begin
       ...
       ages_gandalf_specfit, allpass[ipass], solar=solar
    endfor
