...
; Figure 13 - AGES - MZ evolution
    ...
    below_calibpsym = [6,5,9]
    above_calibpsym = [15,17,16]
...
; local MZ          
          ...
          djs_oplot, massaxis[good], ohlocal[good], $
            line=localline, color=localcolor, thick=6
...
;               poly(massaxis-mzavg.dlogohdz_normmass,mzavg.dlogohdz_coeff)
