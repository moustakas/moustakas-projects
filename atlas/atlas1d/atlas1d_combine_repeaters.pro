...
;
; CALLING SEQUENCE:
;       atlas1d_combine_repeaters, /wfits, /postscript
;
; INPUTS:
;
; OPTIONAL INPUTS:
...
pro atlas1d_combine_repeaters, wfits=wfits
    
    analysis_path = atlas_path(/analysis)
    outpath = atlas_path(/atlas1d);+'repeaters/temp/'
