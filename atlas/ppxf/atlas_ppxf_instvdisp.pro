function atlas_ppxf_instvdisp, bc03_instvdisp=bc03_instvdisp
; jm09dec17ucsd - convolve the BC03 model templates by the ATLAS
; instrumental velocity dispersion (see BUILD_ATLAS_PPXF_TEMPLATES);
