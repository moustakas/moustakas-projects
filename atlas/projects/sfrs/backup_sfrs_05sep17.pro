...
pro sfrs, atlasdust, atlasnodust, nfgsdust, nfgsnodust, atlasdust_agn, $
  ...
  hii, postscript=postscript, paper=paper, blackwhite=blackwhite, $
  cleanpng=cleanpng, _extra=extra

; sfrs, atlasdust, atlasnodust, nfgsdust, nfgsnodust, atlasdust_agn, atlasnodust_agn, nfgsdust_agn, nfgsnodust_agn, sdssdust, sdssnodust, hii
...
; read the data and the models    
    ...
    if (n_elements(sdssdust) eq 0L) then sdssdust = read_sdss_sfrs_sample(sdssnodust=sdssnodust)
...
; read the high-redshift data
    ...
    shap05color = 'dark green'
    shap05sym = 122
    shap05psize = 2.2
    
    sava05color = 'dark blue'
    sava05sym = 115
    sava05psize = 2.2
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=7.0, ysize=8.0, /encapsulated
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=9.25, /encapsulated
...
; #######
    ...
    indx = where(sdssdust.b_lum gt -900.0)
...
; AGN
    ...
    atlas1d_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      /right, /top, position=pos[*,0], atlasfill=1, nfgsfill=1, $ ;atlaspsize=1.0, nfgspsize=1.0, $
...
; overplot the AGN
    ...
    atlas1d_lineplot, x_agn, y_agn, xerr_agn, yerr_agn, $
      ...
      nfgsfill=0, xnfgs=xnfgs_agn, ynfgs=ynfgs_agn, $ ; atlaspsize=1.0, nfgspsize=1.0, $
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=6.5, /encapsulated
...
; SF    
    ...
    atlas1d_lineplot, x, resid, xerr, residerr, plottype=1, postscript=postscript, $
      ...
      xminor=3, yminor=3, atlaspsize=0.6, ytickinterval=1.0, atlascolor=sfcolor

; AGN    
    
    atlas1d_lineplot, x_agn, resid_agn, xerr_agn, residerr_agn, $
    ...
    legend, 'Kennicutt (1998)', /left, /bottom, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl(xstr), /right, /top, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
...
; SF    
    ...
    atlas1d_lineplot, x, resid, xerr, residerr, plottype=1, postscript=postscript, $
      ...
      ytickname=replicate(' ',10), xminor=3, yminor=3, atlaspsize=0.6, $
...
; AGN    
    ...
    legend, '(b)', /left, /top, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl('H\beta/H\gamma'), /left, /bottom, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl(xstr), /right, /top, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
...
; SF    
    ...
    atlas1d_lineplot, x, resid, xerr, residerr, plottype=1, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      charsize=charsize_5, position=pos[*,2], xminor=3, yminor=3, atlaspsize=0.6, $
      ytickinterval=1.0, /noerase, atlascolor=sfcolor
...
; AGN    
    ...
    legend, '(c)', /left, /top, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, 'Kewley et al. (2004)', /left, /bottom, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl(xstr), /right, /top, box=0, charsize=charsize_3, $
      charthick=postthick, clear=keyword_set(postscript)
...
; SF    
    ...
    atlas1d_lineplot, x, resid, xerr, residerr, plottype=1, postscript=postscript, $
      ...
      xminor=3, yminor=3, atlaspsize=0.6, ytickinterval=1.0, /noerase, atlascolor=sfcolor
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=7.0, ysize=7.5, /encapsulated
...
; AGN    
    ...
    legend, '(a)', /left, /top, box=0, charsize=charsize_4, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl('H\beta/H\gamma'), /left, /bottom, box=0, charsize=charsize_4, $
      charthick=postthick, clear=keyword_set(postscript)
...
; SF
    ...
    atlas1d_lineplot, x, resid, xerr, residerr, plottype=1, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      charsize=charsize_8, position=pos[*,1], $
      xminor=3, yminor=3, /noerase, atlaspsize=0.8, ytickinterval=1.0
    djs_oplot, !x.crange, [0,0], line=0, thick=postthick
...
; AGN    
    ...
    legend, '(b)', /left, /top, box=0, charsize=charsize_4, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, 'This Paper', /left, /bottom, box=0, charsize=charsize_4, $
      charthick=postthick, clear=keyword_set(postscript)
    legend, textoidl(xstr), /right, /top, box=0, charsize=charsize_4, charthick=postthick
...
; ------------------------------------------------------------
    ...
    psname = 'lb_vs_ehbha'
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=8.3, /encapsulated
...
; legend
    ...
    im_legend, textoidl(label), /left, /top, box=0, charsize=charsize_2, $
      charthick=postthick1, psym=psym, fill=fill, symsize=1.5, color=color, $
...
; ####################
    ...
    im_symbols, localsym, psize=localpsize, /fill, color=djs_icolor(localcolor)
    djs_oplot, xbig, ybig, ps=8, color=djs_icolor(localcolor)
;   oploterror, xbig, ybig, yerrbig, ps=8, thick=postthick, $
;     color=djs_icolor(localcolor), errcolor=djs_icolor(localcolor), /nohat, errthick=highz_errthick
...
;     /nohat, color=djs_icolor(m05color), errcolor=djs_icolor(m05color)
    ...
    im_symbols, sava05sym, psize=sava05psize, /fill, color=djs_icolor(sava05color), thick=postthick
    djs_oplot, xsava05, ysava05, ps=8, color=sava05color, thick=postthick
;   oploterror, xsava05, ysava05, xerrsava05, yerrsava05, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(sava05color), errcolor=djs_icolor(sava05color)

    im_symbols, liang04sym, psize=liang04psize, /fill, color=djs_icolor(liang04color), thick=postthick
    djs_oplot, xliang04, yliang04, ps=8, color=liang04color, thick=postthick
;   oploterror, xliang04, yliang04, xerrliang04, yerrliang04, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(liang04color), errcolor=djs_icolor(liang04color)

;   im_symbols, k04sym, psize=k04psize, /fill, color=djs_icolor(k04color), thick=postthick
;   djs_oplot, xk04, yk04, ps=8, color=k04color, thick=postthick
;   oploterror, xk04, yk04, xerrk04, yerrk04, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(k04color), errcolor=djs_icolor(k04color)

    im_symbols, lilly03sym, psize=lilly03psize, /fill, color=djs_icolor(lilly03color), thick=postthick
    djs_oplot, xlilly03, ylilly03, ps=8, color=lilly03color, thick=postthick
;   oploterror, xlilly03, ylilly03, xerrlilly03, yerrlilly03, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(lilly03color), errcolor=djs_icolor(lilly03color)
...
; sample
    ...
    oploterror, 7.2, ypos, 0.0, avgerrlocal, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(localcolor)
       
    im_symbols, m05sym, psize=m05psize, /fill, color=djs_icolor(m05color), thick=postthick
    oploterror, 7.5, ypos, 0.0, avgerrm05, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(m05color)
    
    im_symbols, sava05sym, psize=sava05psize, /fill, color=djs_icolor(sava05color), thick=postthick
    oploterror, 7.8, ypos, 0.0, avgerrsava05, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(sava05color)
    
    im_symbols, liang04sym, psize=liang04psize, /fill, color=djs_icolor(liang04color), thick=postthick
    oploterror, 8.1, ypos, 0.0, avgerrliang04, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(liang04color)
    
;   im_symbols, k04sym, psize=k04psize, /fill, color=djs_icolor(k04color), thick=postthick
;   oploterror, 8.4, ypos, 0.0, avgerrk04, /data, thick=postthick, $
;     errthick=postthick, psym=8, errcolor=djs_icolor(k04color)
    
    im_symbols, lilly03sym, psize=lilly03psize, /fill, color=djs_icolor(lilly03color), thick=postthick
    oploterror, 8.4, ypos, 0.0, avgerrlilly03, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(lilly03color)
...
; legend    
    ...
    fill = [1,0,1,1,1,1]
    color = djs_icolor([localcolor,localcolor,m05color,sava05color,liang04color,lilly03color])
;   label = ['Local Sample - Star-Forming','Local Sample - AGN',$
;     'Maier et al. (2005)','Savaglio et al. (2005)',$
;     'Liang et al. (2004)','Kobulnicky et al. (2003, 2004)','Lilly et al. (2003)']
;   psym = [localsym,localsym,m05sym,sava05sym,liang04sym,k04sym,lilly03sym]
;   fill = [1,0,1,1,1,1,1]
;   color = djs_icolor([localcolor,localcolor,m05color,sava05color,liang04color,k04color,lilly03color])
    postthick1 = postthick
...
; ####################
    ...
    im_symbols, localsym, psize=localpsize, /fill, color=djs_icolor(localcolor)
    djs_oplot, xbig, ybig, ps=8, color=localcolor
;   oploterror, xbig, ybig, xerrbig, yerrbig, ps=8, thick=postthick, $
;     color=djs_icolor(localcolor), errcolor=djs_icolor(localcolor), /nohat, errthick=highz_errthick
...
;     /nohat, color=djs_icolor(m05color), errcolor=djs_icolor(m05color)
    ...
    im_symbols, t02sym, psize=t02psize, /fill, color=djs_icolor(t02color), thick=postthick
    djs_oplot, xt02, yt02, ps=8, color=t02color, thick=postthick
;   oploterror, xt02, yt02, xerrt02, yerrt02, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(t02color), errcolor=djs_icolor(t02color)

    im_symbols, h02sym, psize=h02psize, /fill, color=djs_icolor(h02color), thick=postthick
    djs_oplot, xh02, yh02, ps=8, color=h02color, thick=postthick
;   oploterror, xh02, yh02, xerrh02, yerrh02, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(h02color), errcolor=djs_icolor(h02color)

    im_symbols, g99sym, psize=g99psize, /fill, color=djs_icolor(g99color), thick=postthick
    djs_oplot, xg99, yg99, ps=8, color=g99color, thick=postthick
;   oploterror, xg99, yg99, xerrg99, yerrg99, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(g99color), errcolor=djs_icolor(g99color)
...
; sample
    ...
    oploterror, 7.8, ypos, 0.0, avgerrt02, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(t02color)
    
    im_symbols, h02sym, psize=h02psize, /fill, color=djs_icolor(h02color), thick=postthick
    oploterror, 8.1, ypos, 0.0, avgerrh02, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(h02color)
    
    im_symbols, g99sym, psize=g99psize, /fill, color=djs_icolor(g99color), thick=postthick
    oploterror, 8.4, ypos, 0.0, avgerrg99, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(g99color)
...
; legend    
    ...
    fill = [1,0,1,1,1,1]
    color = djs_icolor([localcolor,localcolor,m05color,t02color,h02color,g99color])
    postthick1 = postthick
    im_legend, textoidl(label), /left, /bottom, box=0, charsize=charsize_2, $
...
;   im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=8.8, /encapsulated, color=color
;   pagemaker, nx=1, ny=1, xspace=0, yspace=0.0, width=6.8, height=6.8, $
;     xmargin=[1.4,0.3], ymargin=[0.9,1.1], xpage=8.5, ypage=8.8, $
;     position=pos, /normal
...
;     /nohat, color=djs_icolor(m05color), errcolor=djs_icolor(m05color)
    ...
    im_symbols, shap05sym, psize=shap05psize, /fill, color=djs_icolor(shap05color), thick=postthick
    djs_oplot, xshap05, yshap05, ps=8, color=shap05color, thick=postthick
;   oploterror, xshap05, yshap05, xerrshap05, yerrshap05, ps=8, thick=postthick, errthick=highz_errthick, $
;     /nohat, color=djs_icolor(shap05color), errcolor=djs_icolor(shap05color)
...
;   ypos = 0.25
    ...
    oploterror, 7.8, ypos, 0.0, avgerrshap05, /data, thick=postthick, $
      errthick=postthick, psym=8, errcolor=djs_icolor(shap05color)
...
; legend
    ...
    fill = [1,0,1,1,1,1]
    color = djs_icolor([localcolor,localcolor,m05color,shap05color,sava05color,liang04color])
    postthick1 = postthick
    im_legend, textoidl(label), /left, /bottom, box=0, charsize=charsize_2, $
      charthick=postthick1, psym=psym, fill=fill, symsize=1.3, color=color, $
      spacing=1.8, thick=postthick1
...
; make the plot
    ...
    xtitle = 'log L(B) [L(B)'+sunsymbol()+']'
;   xtitle = 'log L(B) [10^{10} L(B)'+sunsymbol()+']'
...
;   yrange = alog10([1.8D-41,3D-39]) - alog10(sfrnorm) + alog10(elumnorm)
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=7.0, ysize=9.0, /encapsulated
...
; ##########################################################
    ...
    y1errnfgs = 0.4*nfgsdust[indxnfgs].u_err*alog(10.0)*y1
...
;   y1 = atlasdust[indx].u_lum_obs + 0.4*AU
;   y1err = sqrt(atlasdust[indx].u_lum_obs_err^2 + (0.4*AU_err)^2)
;
...
;   y1nfgs = nfgsdust[indxnfgs].u_lum_obs + 0.4*AUnfgs
;   y1errnfgs = sqrt(nfgsdust[indxnfgs].u_lum_obs_err^2 + (0.4*AUnfgs_err)^2)
;   
...
;   ytitle = 'log [L(U)_{cor}/\psi(H\alpha)]-'+string(hasfrconstoffset,format='(I0)')
;   ytitle = 'log [L(U)_{cor}/\psi(H\alpha)]'
    ytitle = 'log [L(U)/L(H\alpha)]_{cor}'
;   yrange2 = sfrUharange - hasfrconstoffset

    atlas1d_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle='', ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      /noerase, xstyle=3, /right, /top, xtickname=replicate(' ',10), $
      xnfgs=xnfgs, ynfgs=ynfgs, xerrnfgs=xerrnfgs, $
      yerrnfgs=yerrnfgs, position=pos[*,1], charsize=charsize_5, xminor=3, yminor=3
...
;   ytitle = 'log [L(U)_{obs}/\psi(H\alpha)]'
;   ytitle = 'log [L(U)_{obs}/L(H\alpha)_{cor}] '
    ...
    atlas1d_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      ...
      yerrnfgs=yerrnfgs, position=pos[*,2], charsize=charsize_5, ytitle=ytitle
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=7.0, ysize=9.5, /encapsulated

    pagemaker, nx=1, ny=3, height=[2.5,2.5,2.5], width=5.5, xmargin=[1.1,0.4], $
      ymargin=[0.9,1.1], xspace=0, yspace=0, xpage=7.0, ypage=9.5, $
      position=pos, /normal
...
;   ytitle = 'log [L([O II])_{cor}/\psi(H\alpha)]-'+string(hasfrconstoffset,format='(I0)')
;   yrange2 = sfroiiharange - hasfrconstoffset

    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle='', ytitle=ytitle, xrange=xrange, yrange=yrange, $
      legendtype=0, /noerase, xtickname=replicate(' ',10), yminor=3, $
...
;   y1 = atlasnodust[indx].oii_3727_lum[0]
;   y1err = atlasnodust[indx].oii_3727_lum[1]
;
;   y2 = atlasnodust[indx].h_alpha_lum[0]
;   y2err = atlasnodust[indx].h_alpha_lum[1]
;
...
;   yerr = sqrt(y1err^2 + y2err^2)
;
;   y1nfgs = nfgsnodust[indxnfgs].oii_3727_lum[0]
;   y1errnfgs = nfgsnodust[indxnfgs].oii_3727_lum[1]
;
;   y2nfgs = nfgsnodust[indxnfgs].h_alpha_lum[0]
;   y2errnfgs = nfgsnodust[indxnfgs].h_alpha_lum[1]
;
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=5.5, /encapsulated
...
;   splog, 'Spearman rank test: ', rcor, probd, zd
    ...
    junk = im_stats(([y,ynfgs])[w],/verbose,sigrej=3.0)
...
;   splog, 'Spearman rank test: ', rcor, probd, zd
    ...
    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      ytitle='', xtitle=xtitle, xrange=xrange, yrange=yrange, legendtype=0, xminor=3, yminor=3, $
...
;   print & running = im_medxbin(x,y,medbin,minx=minx,minpts=minpts,/verbose) & print
    ...
    junk = im_stats(y[w],/verbose,sigrej=3.0)
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=5.7, /encapsulated
...
; SDSS    
    ...
    indx = where((sdssdust.b_lum gt -900) and (sdssdust.zstrong_12oh_oiiinii_niiha gt -900.0),nindx)
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=5.15, /encapsulated
...
; SDSS    
    ...
    indx = where((sdssdust.b_lum gt -900) and (sdssnodust.ehbha_err gt 0.0),nindx)
...
;   ytitle = 'log [L(H\beta)_{obs}/\psi]-'+string(hasfrconstoffset,format='(I0)')
    ...
    atlas1d_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      charsize=charsize_5, position=pos[*,2], /noerase, yminor=3, $
      xnfgs=xnfgs, ynfgs=ynfgs, xerrnfgs=xerrnfgs, yerrnfgs=yerrnfgs
...
;   print & running = im_medxbin(x,y,medbin,minx=minx,minpts=minpts,/verbose) & print
;   running = im_medxbin(x,y,0.25,minpts=100)
;   oploterror, running.binctr, running.medy, replicate(running.binsz/2.0,running.nbins), $
;     running.sigy, ps=-3, thick=postthick, errthick=postthick, /nohat, line=0, errstyle=0
...
; ###############################################################
    ...
    hb = sdssdust[indx].h_beta_lum[0]
    hb_err = sdssdust[indx].h_beta_lum[1]

    ha = sdssnodust[indx].h_alpha_lum[0]
    ha_err = sdssnodust[indx].h_alpha_lum[1]
...
;   xstr = strtrim(string(stats.median,format='(F12.2)'),2)+'\pm'+strtrim(string(stats.sig68mean,format='(F12.2)'),2)
    ...
    ytitle = 'log [10^{-41} L(H\beta)_{obs}/\psi(H\alpha)]'
;   ytitle = 'log [L(H\beta)_{obs}/\psi(H\alpha)]'
    yrange = sfrhbharange - hasfrconstoffset

    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      charsize=charsize_5, position=pos[*,2], /noerase, yminor=3, /silent
;   djs_oplot, !x.crange, -(alog10(HaHb)+loghaconst+hasfrconstoffset)*[1,1], line=0, thick=(postthick-4)>2
;   djs_oplot, !x.crange, -(alog10(HaHb)+loghaconst)*[1,1], line=0, thick=(postthick-4)>2
...
; ------------------------------------------------------------
    ...
    indx = where((sdssdust.model_d4000_narrow[1] gt 0.0) and (sdssdust.fiber_u gt -900) and $
...
;   y1 = sdssdust[indx].fiber_U_lum + 0.4*AU
;   y1err = sqrt(sdssdust[indx].fiber_U_lum_err^2 + (0.4*AU_err)^2)
;
;   y2 = sdssnodust[indx].h_alpha_lum[0]
;   y2err = sdssnodust[indx].h_alpha_lum[1]
;
...
;   yrange2 = sfrUharange - hasfrconstoffset
    ...
    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, xtickname=replicate(' ',10), $
      xtitle='', ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, /noerase, $
      xstyle=3, /right, /top, position=pos[*,1], charsize=charsize_5, xminor=3, yminor=3
...
;   splog, 'Scatter about the running median:'
;   runningy = interpol(running.medy,running.binctr,x)
;   stats = im_stats(y-runningy,/verbose)

; ##########################################################
; Panel 3: U observed, Ha corrected
; ##########################################################

    y1 = sdssdust[indx].fiber_U_lum
    y1err = sdssdust[indx].fiber_U_lum_err
...
;   ytitle = 'log [L(U)_{obs}/L(H\alpha)_{cor}] '
    ...
    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, xtitle=xtitle, $
      ...
      /right, /top, position=pos[*,2], charsize=charsize_5, ytitle=ytitle, yminor=3
...
; ------------------------------------------------------------
    ...
    indx = where((sdssdust.b_lum gt -900) and (sdssnodust.sfr_h_alpha gt -900.0) and $
      (sdssdust.h_beta_ew_uncor[0] ge ewcut),nindx)

    x = sdssdust[indx].b_lum; - alog10(LBnorm)
    xerr = sdssdust[indx].b_lum_err
    xabs = sdssdust[indx].m_b
...
; Atlas - SF
    ...
    uband = atlasdust[indx].u_lum_obs + alog10(lsun) - alog10(Ulumnorm)
...
; Atlas - AGN
    ...
    uband_agn = atlasdust_agn[indx_agn].u_lum_obs + alog10(lsun) - alog10(Ulumnorm)
...
; NFGS - SF
    ...
    ubandnfgs = nfgsdust[indxnfgs].u_lum_obs + alog10(lsun) - alog10(Ulumnorm)
...
; NFGS - AGN
    ...
    ubandnfgs_agn = nfgsdust_agn[indxnfgs_agn].u_lum_obs + alog10(lsun) - alog10(Ulumnorm)
...
; make the plot
    ...
    xtitle = 'log L(B) [L(B)'+sunsymbol()+']'
    ytitle = 'log [10^{43} \psi(H\alpha)/L(U)_{obs}] [erg s^{-1}/'+sfr_units()+']'
...
; generate a latex table with the statistics
       ...
       printf, lun, '\colhead{[\lbsun]} & '
       printf, lun, '\colhead{[mag]} & '
       printf, lun, '\multicolumn{5}{c}{$[10^{43}\,\lunits/(\sfrunits)]$} \\'
...
; ------------------------------------------------------------
; SFR(Ha) vs various SFR(U) calibrations
; ------------------------------------------------------------
...
;   xstr = strtrim(string(stats.median,format='(F12.2)'),2)+'\pm'+strtrim(string(stats.sig68mean,format='(F12.2)'),2)
    ...
    atlas1d_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle=xtitle, ytitle=ytitle, xrange=xrange, yrange=yrange, legendtype=0, $
      xstyle=11, /right, /top, yminor=3, /errorleft, $
      xnfgs=xnfgs, ynfgs=ynfgs, xerrnfgs=xerrnfgs, $
...
; SDSS
    ...
    indx = where((sdssdust.oiii_5007[0]/sdssdust.oiii_5007[1] gt snrcut) and $
      (sdssnodust.b_lum gt -900.0) and (sdssnodust.ehbha_err gt 0.0),nindx)

    x = sdssnodust[indx].b_lum
    xerr = sdssnodust[indx].b_lum_err
    xabs = sdssnodust[indx].m_b
...
;   xstr = strtrim(string(stats.median,format='(F12.2)'),2)+'\pm'+strtrim(string(stats.sig68mean,format='(F12.2)'),2)
    ...
    sdss_lineplot, x, y, xerr, yerr, plottype=3, postscript=postscript, $
      xtitle=xtitle, ytitle='', xrange=xrange, yrange=yrange, legendtype=0, $
      charsize=charsize_5, xstyle=11, position=pos[*,1], /noerase, yminor=3, $
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=4.65, /encapsulated
...
; ------------------------------------------------------------
    ...
    im_openclose, pspath+psname, postscript=postscript, xsize=8.5, ysize=5.0, /encapsulated
...
; --------------------------------------------------    
    ...
    if keyword_set(postscript) and (not keyword_set(blackwhite)) then begin
...
; --------------------------------------------------    
    ...
    if keyword_set(paper) then begin
       ...
       paperplots = [$
         ...
         'd4000_vs_lu_lha_3panel',$
         'sdss_d4000_vs_lu_lha_3panel',$
         'lb_vs_ehbha',$
