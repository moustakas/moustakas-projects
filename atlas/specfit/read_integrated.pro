function read_integrated, atlasnodust=atlasnodust, rasort=rasort, silent=silent
...
; jm05aug26uofa - totally revamped
    ...
    speclinefile = 'integrated_atlas_speclinefit_'+version+'.fits.gz'
    speclinefilenodust = 'integrated_atlas_speclinefit_'+version+'_nodust.fits.gz'
