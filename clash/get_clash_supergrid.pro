function get_clash_supergrid, supergrid, nsuper=nsuper, superstring=superstring, bcg=bcg
...
; unless /BCG
    if keyword_set(bcg) then keep = where(super.supergrid ge 10) else $
      keep = where(super.supergrid lt 10)
    super = super[keep]
