pro hff_hiz1_isedfit, write_paramfile=write_paramfile, build_grids=build_grids, $
...
; jm12sep17siena
    ...
    if keyword_set(photoz) then prefix = 'hff_hiz1_photoz' else prefix = 'a2744'
    isedfit_dir = getenv('CLASH_PROJECTS')+'/hff/hff_hiz1/'
    montegrids_dir = isedfit_dir+'montegrids/'
    isedfit_paramfile = isedfit_dir+prefix+'_paramfile.par'
    
; gather the photometry
    cat = read_hff_hiz1(photoz=photoz)
