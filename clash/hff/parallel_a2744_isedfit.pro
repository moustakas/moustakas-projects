pro parallel_a2744_isedfit, write_paramfile=write_paramfile, build_grids=build_grids, $
...
; jm14jul16siena
    ...
    if keyword_set(photoz) then prefix = 'parallel_a2744_photoz' else prefix = 'parallel_a2744'
