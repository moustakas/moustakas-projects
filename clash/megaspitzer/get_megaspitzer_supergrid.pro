function get_megaspitzer_supergrid, supergrid, nsuper=nsuper, superstring=superstring
; jm12feb09ucsd - read the supergrid parameter file    
    supergrid_paramfile = getenv('CLASH_DIR')+'/megaspitzer/megaspitzer_supergrid.par'
