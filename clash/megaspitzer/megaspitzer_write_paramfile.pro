pro megaspitzer_write_paramfile, paramfile, prefix=prefix, zminmax=zminmax, $
  nzz=nzz, zlog=zlog, igm=igm, super=super, filters=filters
; jm11oct14ucsd - support routine for the various megaspitzer_*_isedfit
; routines
    ...
    filters = megaspitzer_filterlist()
