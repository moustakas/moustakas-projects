pro stellarlocus_decals_scatterplot, xall, yall, xx, yy, xk, yk, $
  ...
  type=type, feh=feh, label=label, position=position, overplot=overplot, $
  contour_color=contour_color, cthick=cthick, contour_linestyle=contour_linestyle
...
;     (strmatch(strtrim(type,2),'*IV*') eq 0))
    ...
    if keyword_set(overplot) then begin
       im_hogg_scatterplot, xall, yall, xrange=xrange, yrange=yrange, xsty=9, $
         ysty=9, /outliers, outcolor=djs_icolor(''), /internal, $
         position=position, /noerase, contour_color=contour_color, $
         /nogrey, cthick=cthick, c_linestyle=contour_linestyle
    endif else begin
       im_hogg_scatterplot, xall, yall, xtitle=xtitle, ytitle=ytitle, $
         xrange=xrange, yrange=yrange, /xsty, /ysty, xthick=3.0, ythick=3.0, $
         charsize=2.0, charthick=3.0, /outliers, outcolor=djs_icolor(''), $
         /internal, position=position, /nogrey, contour_color=contour_color, $
         cthick=cthick, c_linestyle=contour_linestyle
