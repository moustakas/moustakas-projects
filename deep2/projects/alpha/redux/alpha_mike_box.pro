...
pro alpha_mike_box, mike, setup, obj_id, side, exp, STD=std, $
           ...
           ochk=ochk, reschk=reschk, chk=chk, $
           NOHELIO=nohelio, redshift=redshift ; jm08apr16nyu - redshift input required
...
;         skyfil = findfile(skyfil)
      ...
      alpha_x_extechopt, img_sub, skysub, ivar, ordr_shift, objstr, velpix, $
        ochk=ochk, reschk=reschk, chk=chk, img_arc=img_arc, HIGHSNR=highsnr,$
        ...
        FIN_TRC=fin_trc, redshift=redshift, /boxonly, SKIPSKYSUB=skipskysub
