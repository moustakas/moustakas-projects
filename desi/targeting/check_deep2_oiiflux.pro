...
;     'chab_charlot_sfhgrid01_kcorr.z0.0.fits.gz',1)
    deep2 = mrdfits(templatepath+'desi_deep2_template_sample.fits.gz',1)
...
; make the plot
    ...
    good = where(bossoii gt 0)
    ratio = alog10(bossoii[good]/deep2[good].oii_3727[0])
    ratioerr = im_compute_error(bossoii[good],bossoiierr[good],$
      deep2[good].oii_3727[0],deep2[good].oii_3727[1],/log)
