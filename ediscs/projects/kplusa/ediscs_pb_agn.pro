pro ediscs_pb_agn, postscript=postscript
; jm08may09nyu - what fraction of the galaxies in the SDSS classified
;                as k+a's using Bianca's definitions are AGN?

; read the data       
       
    sdss = read_sdss_main(/ispec)
    kcorr = read_sdss_main(/kcorr)
