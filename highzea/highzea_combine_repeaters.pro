...
;
; CALLING SEQUENCE:
;       highzea_combine_repeaters, /wfits
;
; INPUTS:
;
; OPTIONAL INPUTS:
...
pro highzea_combine_repeaters, wfits=wfits
    
    analysis_path = highzea_path(/analysis)
    outpath = highzea_path(/spec1d);+'repeaters/temp/'
    repeatpath = highzea_path(/spec1d)+'repeaters/'

; read the text file    
    
    repeatersfile = 'highzea_combine_repeaters.txt'
