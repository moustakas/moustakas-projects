...
; echo "isedfit_vs_salim, /ised, /models, /cl" | idl > & doit1.log &
    ...
    iopath = './'
    paramfile = iopath+'isedfit_vs_salim.par'
...
; build a test sample    
    if keyword_set(build_parent) then begin
       ...
       keep = where((post[m1].z gt 0.05) and (post[m1].z lt 0.2) and (kauff[m1].mass_median gt 0.0) and $
...
;      salim = mrdfits(iopath+'salim07.fits.gz',1)
...
;      parent.z = salim.z
       ...
       isedfit, paramfile, parent.maggies, parent.ivarmaggies, parent.z, $
         result, iopath=iopath, outprefix=outprefix, galchunksize=1000, $
...
;         'More Dust, Z=0.004-0.05, No bursts']
       ...
       psfile = iopath+'qaplot_ised_vs_salim.ps'
