pro lozlae_rebin, spec1d, velscale=velscale, fluxscale=fluxscale, $
...
pro lozlae_zabs_vdisp, wave, flux, ferr, tempwave=tempwave, $
...
function lozlae_fit_continuum, wave, flux, ferr, tempwave=tempwave, $
...
function lozlae_fit_lines, wave, flux, ferr, continuum, smooth_continuum, $
...
function lozlae_smooth_residuals, wave, flux, continuum, $
...
pro lozlae_gandalf_specfit, debug=debug, solar=solar
; jm10dec06ucsd - fit some Lozlaespec spectra for Papovich's postdoc 
...
; convolve to AGES pixel size and instrumental resolution
    ...
    tempflux = read_lozlae_ppxf_templates(tempwave,ntemp=ntemp,$
...
; logarithmically rebin the spectrum
       lozlae_rebin, spec1d[iobj], velscale=velscale, fluxscale=fluxscale, $
...
;          lozlae_zabs_vdisp, wave, flux, ferr, tempwave=tempwave, $
...
; get a better estimate of the absorption-line redshift
          continuum1 = lozlae_fit_continuum(wave,flux,ferr,tempwave=tempwave, $
...
; smooth the residuals before before fitting the lines
       smooth_continuum = lozlae_smooth_residuals(wave,flux,$
         continuum,zabs=zabs,velscale=velscale,broad=broad,$
         linefile=linefile,debug=debug)

; finally fit the emission lines
       sol = lozlae_fit_lines(wave,flux,ferr,continuum,smooth_continuum,$
         zabs=zabs,vdisp=vdisp,velscale=velscale,linefile=linefile,$
