function update_vlt_header, h, hinfo, bias=bias, arclamp=arclamp, $
  domeflat=domeflat, object=object
; jm04nov05uofa
; keywords that need to be added or modified to the VLT header to be
...
; UT, APERTURE, RDNOISE, GAIN
    ...
    gain = float(hinfo.det_out1_gain)
    rdnoise = float(hinfo.det_out1_ron)
    ...
    sxaddpar, newh, 'RDNOISE', rdnoise;, after='UT'
    sxaddpar, newh, 'GAIN', gain;, after='RDNOISE'
