function read_sings_ppxf_templates, out_tempwave, velscale=velscale, $
...
; jm10feb25ucsd - read the output from BUILD_SINGS_PPXF_TEMPLATES and
...
;   common ppxf_templates, tempflux, tempwave, temphdr, tempinfo
    ...
    if (n_elements(tempflux) eq 0) then begin
       ...
       templatefile = sings_path(/ppxf)+'bc03_'+metal+$
         '_'+sings_version(/ppxf_templates)+'.fits.gz'
