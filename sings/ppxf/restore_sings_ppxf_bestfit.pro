function restore_sings_ppxf_bestfit, weights1, ebv=ebv, $
...
;   is very small - see BUILD_AGES_PRIMUS_PARENTSAMPLE)
    ...
    if (ndim eq 0) then begin
       doc_library, 'restore_sings_ppxf_bestfit'
       return, -1
    endif
    ...
    if (ndim eq 2) then begin
       ...
       for jj = 0, dims[1]-1 do begin
          modelflux1 = restore_sings_ppxf_bestfit(weights1[*,jj],$
...
; read the templates and redden    
    tempflux = read_sings_ppxf_templates(bestwave,ntemp=ntemp,$
