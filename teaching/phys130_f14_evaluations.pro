...
pro phys130_f14_evaluations, finn=finn
; jm14sep24siena 

    path = getenv('TEACHING_DIR')+'/shared/Phys130/130-F14/evaluations/'
    
    semester = 'Fall 2014'
    class = 'Physics 130 - General Physics I'
    
; read the evaluation form downloaded from GoogleDocs
    if keyword_set(finn) then suffix = 'finn' else suffix = 'moustakas'
...
; agree...disagree questions - questions 0-9
    indx = lindgen(10)
...
; hard..easy questions - questions 12-14
    indx = [12,13,14]
    for ii = 0, n_elements(indx)-1 do begin
...
; number of hours questions - question 10,11
    indx = [10,11]
    for ii = 0, n_elements(indx)-1 do begin
...
; never...every week questions - questions 15,16
    indx = [15,16]
    for ii = 0, n_elements(indx)-1 do begin
