pro build_wise_ppxf_templates, debug=debug
; jm11apr13ucsd - write out the basic set of BC03 templates for the
;   PPXF template fitting

    outpath = wise_path(/ppxf)
    light = 299792.458D
    lsun = 3.826D33         ; [erg/s]
    dist = 10.0*3.085678D18 ; 10 pc [cm]

    agegrid = [5.0,25.0,50.0,125.0,300.0,650.0,$
      1500.0,3000.0,7000.0,10500.0]
