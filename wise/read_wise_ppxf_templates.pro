function read_wise_ppxf_templates, out_tempwave, velscale=velscale, $
...
; jm11apr13ucsd - read the output from BUILD_WISE_PPXF_TEMPLATES and
...
;   common ppxf_templates, tempflux, tempwave, temphdr, tempinfo
    ...
    if (n_elements(tempflux) eq 0) then begin
       ...
       templatefile = wise_path(/ppxf)+'bc03_'+metal+'.fits.gz'
